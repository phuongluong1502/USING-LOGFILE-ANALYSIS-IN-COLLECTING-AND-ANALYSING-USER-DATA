                            ...
                            <form id="form_validation" method="POST">
                                ...
                                <div class="row cleafix">
                                    <div class="col-lg-4 col-md-4 col-sm-3 col-xs-6">
                                       ...
                                       <input type="radio" id="AnHien_1" name="AnHien" <?=($row['AnHien']==1)?"checked":""?> value="1" >
                                       <label for="AnHien_1" class="m-l-20">Hiện</label>
                                       </div>
                                    </div>
                                    <div class="col-lg-4 col-md-4 col-sm-3 col-xs-6">
                                       <div class="form-group form-float">
                                       <input type="radio" id=" TinNoiBat_0" name=" TinNoiBat" value="0" <?=($row['TinNoiBat']==0)?"checked":""?> >
                                       <label for="TinNoiBat_0">Tin thường</label>
                                       <input type="radio" id="TinNoiBat_1" name="TinNoiBat" <?=($row['TinNoiBat']==1)?"checked":""?> value="1" >
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                       <div class="form-group form-float">
                                       <div class="form-line">
                                       <input type="text" class="datepicker form-control" name="Ngay" value="<?=date('d/m/Y',strtotime($row['Ngay']))?>" >
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <textarea name="NoiDungTin" cols="30" rows="10" class="form-control" required><?=$row['Content']?></textarea>
                                    </div>
                                </div>                               
