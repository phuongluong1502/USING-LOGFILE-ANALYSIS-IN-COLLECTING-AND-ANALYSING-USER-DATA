...
<thead>
<tr>  <th>idTL</th> <th>TênTL</th> <th>Thứ Tự</th> <th>Ẩn Hiện</th>
      <th>TenTL_KhongDau</th> <th>Cập nhật/Xóa</th> 
</tr>
</thead>
<tbody>
	<?php $kq = $qt->ListTheLoai(); ?>
	<?php while ($rowTL = $kq->fetch_assoc() ) { ?>
    <tr> <td><?=$rowTL['idTL']?></td> <td><?=$rowTL['TenTL']?></td>
         <td><?=$rowTL['ThuTu']?></td> <td><?=($rowTL['AnHien']==1)?"Đang hiện":"Đang ẩn"?></td> <td><?=$rowTL['TenTL_KhongDau']?></td>
